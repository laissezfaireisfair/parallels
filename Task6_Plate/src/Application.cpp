...
Application::Application(CmdArguments arguments) : arguments_(arguments) {
...
Grid Application::CreateStartGrid() const {
...
double Application::RunOneIter(Grid const& grid, Grid& grid_after_step) const {
  double max_diff = 0.;
